 ...
 * Termos profissionais (Skills, Plugins, Commands, Sessions, OpenCode, OpenPackage, OpenWork Plus) NÃO são traduzidos
 */
...
export default {
  ...
  "app.deep_link_auth_queued": "Link de autenticação Cloud enfileirado para o OpenWork Plus.",
  "app.deep_link_remote_queued": "Link de worker remoto enfileirado. O OpenWork Plus deve entrar no fluxo de conexão.",
  ...
  "app.error_auto_compact_scope": "A compactação automática de contexto só pode ser alterada para um workspace local ou um workspace de servidor OpenWork Plus com permissão de escrita.",
  ...
  "app.error_deep_link_unrecognized": "Esse link não é um deep link ou URL de compartilhamento reconhecido do OpenWork Plus.",
  ...
  "app.plugins_hint_disconnected": "Servidor OpenWork Plus indisponível. Plugins estão em modo somente leitura.",
  "app.plugins_hint_limited": "O servidor OpenWork Plus precisa de um token para editar plugins.",
  "app.plugins_hint_readonly": "O servidor OpenWork Plus está em modo somente leitura para plugins.",
  ...
  "app.reset_config_ok": "Configurações padrão do app redefinidas. Reinicie o OpenWork Plus se alguma configuração obsoleta permanecer.",
  "app.shared_setup": "Configuração compartilhada",
  "app.skill_added": "Skill adicionada",
  "app.skills_hint_disconnected": "Servidor OpenWork Plus indisponível. Adicione a URL/token do servidor em Avançado para gerenciar skills.",
  "app.skills_hint_limited": "O servidor OpenWork Plus precisa de um token de host para instalar/atualizar skills. Adicione-o em Avançado e reconecte.",
  "app.skills_hint_readonly": "O servidor OpenWork Plus está em modo somente leitura para skills. Adicione um token de host em Avançado para habilitar instalações.",
  ...
  "automations.server_needs_token": "O servidor OpenWork Plus precisa de um token para carregar tarefas agendadas.",
  "automations.server_not_ready": "Servidor OpenWork Plus não está pronto.",
  "automations.server_unavailable": "Servidor OpenWork Plus indisponível. Conecte para sincronizar tarefas agendadas.",
  ...
  "blueprint.welcome_message": "Olá, boas-vindas ao OpenWork Plus!\n\nAs pessoas usam o OpenWork Plus para escrever arquivos .csv no computador, conectar ao Chrome e automatizar tarefas repetitivas, e sincronizar contatos com o Notion.\n\nMas o único limite é a sua imaginação.\n\nO que você gostaria de fazer?",
  "blueprint.welcome_title": "Boas-vindas ao OpenWork Plus",
  ...
  "config.reload_availability_hint": "O recarregamento está disponível apenas para workers locais ou servidores OpenWork Plus conectados.",
  ...
  "config.server_needed_hint": "Conexão com o servidor OpenWork Plus necessária para sincronizar skills, plugins e comandos.",
  "config.server_section_desc": "Conecte a um servidor OpenWork Plus. Use a URL mais um token de colaborador ou proprietário do administrador do servidor.",
  ...
  "config.server_sharing_title": "Compartilhamento do servidor OpenWork Plus",
  "config.server_url_hint": "Use a URL compartilhada pelo seu servidor OpenWork Plus. Workers locais do desktop reutilizam uma porta alta persistente na faixa 48000-51000.",
  "config.server_url_input_label": "URL do servidor OpenWork Plus",
  "config.server_url_label": "URL do Servidor OpenWork Plus",
  ...
  "context_panel.authorized_folders_no_access": "Conecte a um workspace OpenWork Plus com permissão de escrita para editar as pastas autorizadas.",
  "context_panel.browse_button": "Navegar",
  "context_panel.config_access_unavailable": "O acesso à configuração do servidor OpenWork Plus não está disponível para este workspace.",
  "context_panel.config_read_only": "O servidor OpenWork Plus está conectado em modo somente leitura para configuração do workspace.",
  ...
  "context_panel.server_disconnected": "Servidor OpenWork Plus desconectado.",
  ...
  "context_panel.writable_workspace_required": "É necessário um workspace OpenWork Plus com permissão de escrita para atualizar as pastas autorizadas.",
  ...
  "dashboard.chooser_remote_desc": "Conecte a um worker OpenWork Plus auto-hospedado usando uma URL e token de acesso.",
  ...
  "dashboard.create_remote_custom_subtitle": "Conecte a um worker OpenWork Plus auto-hospedado.",
  ...
  "dashboard.create_remote_workspace_subtitle": "Salvar um servidor OpenWork Plus como workspace.",
  ...
  "dashboard.edit_remote_workspace_subtitle": "Atualizar os dados do servidor OpenWork Plus para este workspace.",
  ...
  "dashboard.openwork_host_hint": "Use a URL fornecida pelo seu servidor OpenWork Plus.",
  "dashboard.openwork_host_label": "URL do servidor OpenWork Plus",
  ...
  "dashboard.remote_server_details_hint": "Conecte a um worker OpenWork Plus auto-hospedado.",
  "dashboard.remote_server_details_title": "Detalhes do servidor remoto",
  "dashboard.remote_workspace_hint": "Acompanhe um servidor OpenWork Plus e reconecte a qualquer momento.",
  ...
  "dashboard.worker_url_hint": "Cole a URL do worker OpenWork Plus ao qual deseja conectar.",
  ...
  "den.auto_reconnect_hint": "Conclua a autenticação no navegador e o OpenWork Plus reconectará aqui automaticamente.",
  ...
  "den.cloud_workers_hint": "Abra workers diretamente no OpenWork Plus usando o mesmo fluxo de conexão remota que o app já usa.",
  ...
  "den.error_open_worker": "Falha ao abrir {name} no OpenWork Plus.",
  "den.error_open_worker_fallback": "Falha ao abrir {name}.",
  "den.error_paste_valid_code": "Cole um link de login do OpenWork Plus válido ou um código de uso único.",
  ...
  "den.signin_link_hint": "Se o navegador não redirecionar de volta para o OpenWork Plus automaticamente, cole o link de login ou código de uso único do OpenWork Cloud aqui.",
  ...
  "den.status_browser_signin": "Conclua o login no navegador para conectar o OpenWork Plus.",
  "den.status_browser_signup": "Conclua a criação da conta no navegador para conectar o OpenWork Plus.",
  ...
  "den.status_opened_worker": "{name} aberto no OpenWork Plus.",
  ...
  "identities.connect_server_desc": "As identidades ficam disponíveis quando você está conectado a um servidor OpenWork Plus.",
  "identities.connect_server_title": "Conectar a um servidor OpenWork Plus",
  ...
  "identities.reconnect_failed": "Falha ao reconectar. Verifique a URL/token do OpenWork Plus e tente novamente.",
  ...
  "mcp.apps_subtitle": "Conecte suas ferramentas favoritas para que o OpenWork Plus as use em seu nome.",
  "mcp.apps_title": "Apps",
  ...
  "mcp.auth.reload_notice": "Para isso ter efeito, o OpenWork Plus precisa reiniciar o serviço worker. Isso pode interromper uma sessão em andamento.",
  "mcp.auth.reload_remote_confirm": "Para isso ter efeito, o OpenWork Plus precisa reiniciar o serviço worker. Isso pode parar sua sessão em andamento. Continuar?",
  ...
  "mcp.auth.step2_title": "Autorizar o OpenWork Plus",
  ...
  "mcp.control_chrome_profile_hint": "O Control Chrome normalmente abre um perfil separado do Chrome. Ative isso se quiser que o OpenWork Plus reutilize a janela do Chrome que você já tem aberta.",
  "mcp.control_chrome_profile_title": "2. Escolher qual Chrome usar",
  "mcp.control_chrome_save": "Salvar configurações",
  "mcp.control_chrome_setup_subtitle": "Ative o acesso ao Chrome e escolha se o OpenWork Plus deve usar seu próprio perfil limpo ou se conectar ao Chrome que você já usa.",
  "mcp.control_chrome_setup_title": "Configurar Control Chrome",
  "mcp.control_chrome_toggle_hint": "Quando ativado, o OpenWork Plus adiciona --autoConnect para que o MCP se conecte a uma instância do Chrome que você já iniciou.",
  "mcp.control_chrome_toggle_label": "Usar meu perfil existente do Chrome",
  "mcp.control_chrome_toggle_off": "O OpenWork Plus abrirá um perfil separado do Chrome apenas para automação.",
  "mcp.control_chrome_toggle_on": "O OpenWork Plus reutilizará suas abas, cookies e logins atuais.",
  ...
  "mcp.login_unavailable": "Este app não suporta login pelo OpenWork Plus.",
  ...
  "onboarding.cli_install_commands": "Instale o OpenCode com um dos comandos abaixo e reinicie o OpenWork Plus.",
  ...
  "onboarding.remote_workspace_card_description": "Conecte a um servidor OpenWork Plus para acessar um workspace compartilhado.",
  "onboarding.remote_workspace_card_title": "Conectar um workspace remoto",
  "onboarding.remote_workspace_description": "Conecte a um servidor OpenWork Plus para acessar um workspace de qualquer lugar.",
  "onboarding.remote_workspace_title": "Conectar ao servidor OpenWork Plus",
  "onboarding.remove": "Remover",
  "onboarding.resolved_path": "Caminho resolvido",
  "onboarding.run_local": "Executar localmente",
  "onboarding.run_local_description": "O OpenWork Plus executa o OpenCode localmente e mantém seu trabalho privado.",
  "onboarding.search_notes": "Notas de busca",
  "onboarding.searching_host": "Conectando ao servidor OpenWork Plus...",
  ...
  "onboarding.starting_host": "Iniciando servidor OpenWork Plus...",
  ...
  "onboarding.welcome_title": "Como você quer executar o OpenWork Plus hoje?",
  "onboarding.windows_install_instruction": "Instale o OpenCode para Windows e reinicie o OpenWork Plus. Certifique-se de que opencode.exe está no PATH.",
  ...
  "scheduled.reload_activate_hint": "O OpenCode carrega plugins na inicialização. Recarregue o OpenWork Plus para ativar o opencode-scheduler.",
  "scheduled.reload_activate_title": "Recarregue o OpenWork Plus para ativar automações",
  "scheduled.reload_openwork": "Recarregar OpenWork Plus",
  ...
  "scheduled.source_remote": "Do servidor OpenWork Plus",
  "scheduled.subtitle_local": "Automações que rodam em um agendamento a partir deste dispositivo.",
  "scheduled.subtitle_remote": "Automações que rodam em um agendamento a partir do servidor OpenWork Plus conectado.",
  ...
  "session.attachments_connect_server": "Conecte ao servidor OpenWork Plus para anexar arquivos.",
  "session.back": "Voltar",
  ...
  "session.connect_to_sync": "Conecte ao servidor OpenWork Plus para sincronizar arquivos remotos.",
  ...
  "session.pick_folder_desc": "Escolha uma pasta de projeto ou notas existente e o OpenWork Plus a usará como workspace.",
  ...
  "session.share_host_url_and_token_required": "URL do host OpenWork Plus e token são obrigatórios.",
  "session.share_local_host_not_ready": "O host local do OpenWork Plus ainda não está pronto.",
  "session.share_missing_host_url": "URL do host OpenWork Plus ausente.",
  "session.share_missing_token": "Token do OpenWork Plus ausente.",
  ...
  "session.share_openwork_workers_only": "Links de compartilhamento estão disponíveis para workers OpenWork Plus.",
  ...
  "session.share_resolve_local_workspace_failed": "Não foi possível resolver este workspace no host local do OpenWork Plus.",
  "session.share_resolve_remote_workspace_failed": "Não foi possível resolver este workspace no host do OpenWork Plus.",
  ...
  "session.share_skills_set_desc": "Conjunto completo de skills de um workspace OpenWork Plus.",
  ...
  "session.share_workspace_template_desc": "Template completo de workspace OpenWork Plus com config, comandos, skills e arquivos .opencode extras.",
  ...
  "session.upload_connect_server": "Conecte ao servidor OpenWork Plus para enviar arquivos para a pasta compartilhada.",
  ...
  "session.workspace_setup_desc": "Comece com um workspace guiado do OpenWork Plus ou escolha uma pasta existente.",
  ...
  "settings.background_checks_desc": "O OpenWork Plus sempre verifica ao iniciar. Também verifica uma vez",
  ...
  "settings.capabilities_title": "Capacidades do servidor OpenWork Plus",
  ...
  "settings.custom_binary_hint": "Use para apontar o OpenWork Plus para um build local do OpenCode",
  ...
  "settings.docker_containers_desc": "Forçar remoção de containers Docker iniciados pelo OpenWork Plus",
  "settings.docker_containers_title": "Containers Docker do OpenWork Plus",
  ...
  "settings.enable_exa_desc": "Aplica-se quando o OpenWork Plus Orchestrator inicia o OpenCode.",
  ...
  "settings.feedback_title": "Ajude a moldar o OpenWork Plus",
  ...
  "settings.nuke_confirm_dev": "Isso é irreversível. EXCLUIRÁ todos os dados do OpenWork Plus para este build dev e toda config, auth, cache, dados e estado isolados do OpenCode dev, e fechará o OpenWork Plus. Continuar?",
  "settings.nuke_confirm_prod": "Isso é irreversível. EXCLUIRÁ todos os dados do OpenWork Plus para este build dev e toda config, auth, cache, dados e estado isolados do OpenCode dev, e fechará o OpenWork Plus. Continuar?",
  "settings.nuke_failed": "Falha ao remover estado do OpenWork Plus e OpenCode.",
  "settings.nuke_hint": "Use apenas quando quiser resetar completamente o app desktop e o estado do runtime OpenCode.",
  "settings.nuke_success": "Estado do OpenWork Plus e OpenCode removido. O OpenWork Plus está fechando...",
  "settings.off": "Desativado",
  "settings.offline": "Offline",
  "settings.on": "Ativado",
  "settings.open_deeplink_action": "Abrindo...",
  "settings.open_deeplink_button": "Ocultar",
  "settings.open_deeplink_desc": "Cole um deeplink ou URL compartilhada do OpenWork Plus para abrir.",
  ...
  "settings.openwork_diagnostics_title": "Diagnósticos do servidor OpenWork Plus",
  ...
  "settings.quit_hint": "O OpenWork Plus fecha imediatamente após a limpeza para que a próxima inicialização comece de um estado local limpo para este modo.",
  ...
  "settings.reconnect_server_failed": "Falha ao reconectar o servidor OpenWork Plus.",
  "settings.reconnected": "Reconectado ao servidor OpenWork Plus.",
  ...
  "settings.reset_app_data_description": "Mais agressivo. Apaga cache + dados do OpenWork Plus.",
  "settings.reset_app_data_title": "Redefinir dados do app",
  "settings.reset_app_data_warning": "Apaga cache e dados do OpenWork Plus neste dispositivo.",
  ...
  "settings.reset_confirmation_hint": "Digite {resetWord} para confirmar. O OpenWork Plus será reiniciado.",
  ...
  "settings.reset_onboarding_description": "Apaga as preferências do OpenWork Plus e reinicia o app.",
  "settings.reset_onboarding_title": "Redefinir onboarding",
  "settings.reset_onboarding_warning": "Apaga preferências locais e marcadores de onboarding do workspace no OpenWork Plus.",
  ...
  "settings.reset_openwork_title": "Redefinir estado do OpenWork Plus + OpenCode",
  ...
  "settings.restart_blocked_message": "O OpenWork Plus precisa reiniciar para concluir esta atualização. Para não interromper seu trabalho atual, a instalação está pausada até que suas execuções ativas terminem ou sejam paradas.",
  ...
  "settings.runtime_desc": "Status do seu engine local e servidor OpenWork Plus.",
  ...
  "settings.tab_description_appearance": "Ajuste a aparência do OpenWork Plus no desktop, tema do sistema e decoração do app.",
  ...
  "settings.tab_description_general": "Conecte provedores, escolha o modelo padrão, autorize pastas e controle o workspace OpenWork Plus selecionado e sua conexão de runtime.",
  ...
  "settings.updates_desc": "Manter o OpenWork Plus atualizado.",
  ...
  "share.template_item_config_desc": "Comandos reutilizáveis mais configuração do OpenWork Plus/OpenCode.",
  ...
  "share_skill_destination.connect_remote_desc": "Vincular um host OpenWork Plus e selecioná-lo na lista para importar esta skill.",
  "share_skill_destination.connect_remote_hint": "Vincule um host OpenWork Plus e selecione-o na lista para importar esta skill.",
  ...
  "skills.add_openwork_hub": "Adicionar OpenWork Plus Hub",
  ...
  "skills.cloud_install_need_server": "Conecte a um servidor OpenWork Plus com acesso de escrita a skills para instalar skills de equipe neste worker.",
  ...
  "skills.host_only_error": "O gerenciamento de skills requer um workspace local ou servidor OpenWork Plus conectado.",
  ...
  "status.limited_hint": "Reconecte para restaurar todos os recursos do OpenWork Plus",
  ...
  "status.openwork_ready": "OpenWork Plus Pronto",
  ...
  "system.reload_body_default": "O OpenWork Plus detectou mudanças que exigem recarregar a instância do OpenCode.",
  "system.reload_body_mcp": "O OpenCode carrega servidores MCP na inicialização. Recarregue o engine para ativar a nova conexão.",
  "system.reload_body_mixed": "O OpenWork Plus detectou mudanças na configuração do OpenCode. Recarregue o engine para aplicá-las.",
