...
export default {
  ...
  "settings.bundles.catalog_install_unavailable_title": "暂不支持一键安装",
  "settings.bundles.catalog_install_unavailable_hint": "当前版本还不能从目录直接安装。请用上方的\"从 zip 安装\"为 {id} 选择对应 .zip 文件（P2.5 会补齐此能力）。",
