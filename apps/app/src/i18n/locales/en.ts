...
export default {
  ...
  "settings.bundles.catalog_install_unavailable_title": "Direct install not available yet",
  "settings.bundles.catalog_install_unavailable_hint": "Catalog entries cannot be installed in-place in this build. Use \"Install from zip\" with the matching .zip for {id} (P2.5 will wire this up).",
