...
export default {
  ...
  "app.deep_link_auth_queued": "Queued the Cloud auth deep link for OpenWork Plus.",
  "app.deep_link_remote_queued": "Queued remote worker link. OpenWork Plus should move into the connect flow.",
  ...
  "app.error_deep_link_unrecognized": "That link is not a recognized OpenWork Plus deep link or share URL.",
  ...
  "app.reset_config_ok": "Reset app config defaults. Restart OpenWork Plus if any stale settings remain.",
  ...
  "den.auto_reconnect_hint": "Finish auth in your browser and OpenWork Plus will reconnect here automatically.",
  ...
  "den.cloud_workers_hint": "Open workers directly into OpenWork Plus using the same remote-connect flow the app already uses elsewhere.",
  ...
  "den.error_open_worker": "Failed to open {name} in OpenWork Plus.",
  "den.error_open_worker_fallback": "Failed to open {name}.",
  "den.error_paste_valid_code": "Paste a valid OpenWork Plus sign-in link or one-time sign-in code.",
  ...
  "den.signin_link_hint": "If your browser doesn't bounce back into OpenWork Plus automatically, paste the sign-in link or one-time code from OpenWork Cloud here.",
  ...
  "den.status_browser_signin": "Finish signing in in your browser to connect OpenWork Plus.",
  "den.status_browser_signup": "Finish account creation in your browser to connect OpenWork Plus.",
  ...
  "den.status_opened_worker": "Opened {name} in OpenWork Plus.",
  ...
  "mcp.apps_subtitle": "Connect your favorite tools so OpenWork Plus can use them on your behalf.",
  "mcp.apps_title": "Apps",
  ...
  "mcp.auth.reload_notice": "For this to take effect, OpenWork Plus needs to refresh the worker service. This can interrupt a running session.",
  "mcp.auth.reload_remote_confirm": "For this to take effect, OpenWork Plus needs to refresh the worker service. This might stop your running session. Continue?",
  ...
  "mcp.auth.step2_title": "Authorize OpenWork Plus",
  ...
  "mcp.control_chrome_profile_hint": "Control Chrome normally opens a separate Chrome profile. Turn this on if you want OpenWork Plus to reuse the Chrome window you already have open.",
  "mcp.control_chrome_profile_title": "2. Choose which Chrome to use",
  "mcp.control_chrome_save": "Save settings",
  "mcp.control_chrome_setup_subtitle": "Turn on Chrome access, then choose whether OpenWork Plus should use its own clean profile or attach to the Chrome you already use.",
  "mcp.control_chrome_setup_title": "Set up Control Chrome",
  "mcp.control_chrome_toggle_hint": "When this is on, OpenWork Plus adds --autoConnect so the MCP attaches to a Chrome instance you already started.",
  "mcp.control_chrome_toggle_label": "Use my existing Chrome profile",
  "mcp.control_chrome_toggle_off": "OpenWork Plus will launch a separate Chrome profile just for automation.",
  "mcp.control_chrome_toggle_on": "OpenWork Plus will reuse your current tabs, cookies, and sign-ins.",
  ...
  "mcp.login_unavailable": "This app does not support sign-in from OpenWork Plus.",
  ...
  "onboarding.cli_install_commands": "Install OpenCode with one of the commands below, then restart OpenWork Plus.",
  ...
  "onboarding.run_local_description": "OpenWork Plus runs OpenCode locally and keeps your work private.",
  ...
  "onboarding.start": "Start OpenWork Plus",
  ...
  "onboarding.welcome_title": "How would you like to run OpenWork Plus today?",
  "onboarding.windows_install_instruction": "Install OpenCode for Windows, then restart OpenWork Plus. Ensure opencode.exe is on PATH.",
  ...
  "scheduled.reload_activate_hint": "OpenCode loads plugins at startup. Reload OpenWork Plus to activate opencode-scheduler.",
  "scheduled.reload_activate_title": "Reload OpenWork Plus to activate automations",
  "scheduled.reload_openwork": "Reload OpenWork Plus",
  ...
  "session.pick_folder_desc": "Choose an existing project or notes folder and OpenWork Plus will use it as your workspace.",
  ...
  "session.share_missing_token": "Missing OpenWork Plus token.",
  ...
  "session.share_skills_set_desc": "Complete skills set from an OpenWork Plus workspace.",
  ...
  "session.share_workspace_template_desc": "Full OpenWork Plus workspace template with config, commands, skills, and extra .opencode files.",
  ...
  "session.workspace_setup_desc": "Start with a guided OpenWork Plus workspace, or choose an existing folder you want to work in.",
  ...
  "settings.background_checks_desc": "OpenWork Plus always checks on launch. Also checks once",
  ...
  "settings.custom_binary_hint": "Use this to point OpenWork Plus at a local OpenCode build",
  ...
  "settings.docker_containers_desc": "Force-remove Docker containers launched by OpenWork Plus",
  "settings.docker_containers_title": "OpenWork Plus Docker containers",
  ...
  "settings.enable_exa_desc": "Applies when OpenWork Plus Orchestrator launches OpenCode. Off by",
  ...
  "settings.feedback_title": "Help shape OpenWork Plus",
  ...
  "settings.nuke_confirm_dev": "This is irreversible. It WILL delete all OpenWork Plus data for this dev build and all isolated OpenCode dev config, auth, cache, data, and state, then quit OpenWork Plus. Continue?",
  "settings.nuke_confirm_prod": "This is irreversible. It WILL delete all OpenWork Plus data for this dev build and all isolated OpenCode dev config, auth, cache, data, and state, then quit OpenWork Plus. Continue?",
  "settings.nuke_failed": "Failed to remove OpenWork Plus and OpenCode state.",
  "settings.nuke_hint": "Use this only when you want to fully reset the desktop app and its OpenCode runtime state.",
  "settings.nuke_success": "Removed OpenWork Plus and OpenCode state. OpenWork Plus is closing...",
  "settings.off": "Off",
  "settings.offline": "Offline",
  "settings.on": "On",
  "settings.open_deeplink_action": "Opening...",
  "settings.open_deeplink_button": "Hide",
  "settings.open_deeplink_desc": "Paste an OpenWork Plus deeplink or share URL to open it.",
  ...
  "settings.quit_hint": "OpenWork Plus quits immediately after cleanup so the next launch starts from a blank local state for this mode.",
  ...
  "settings.reset_app_data_description": "More aggressive. Clears OpenWork Plus cache + app data.",
  "settings.reset_app_data_title": "Reset app data",
  "settings.reset_app_data_warning": "Clears OpenWork Plus cache and app data on this device.",
  ...
  "settings.reset_confirmation_hint": "Type {resetWord} to confirm. OpenWork Plus will restart.",
  ...
  "settings.reset_onboarding_description": "Clears OpenWork Plus preferences and restarts the app.",
  "settings.reset_onboarding_title": "Reset onboarding",
  "settings.reset_onboarding_warning": "Clears OpenWork Plus local preferences and workspace onboarding markers.",
  ...
  "settings.reset_openwork_title": "Reset OpenWork Plus + OpenCode state",
  ...
  "settings.restart_blocked_message": "OpenWork Plus needs to restart to finish this update. To avoid interrupting your current work, install is paused until your active runs finish or you stop them.",
  ...
  "settings.tab_description_appearance": "Adjust how OpenWork Plus looks across desktop, system theme, and app chrome.",
  ...
  "settings.tab_description_bundles": "Install industry scenario bundles (skills, MCP, commands, CLI, plugin UI).",
  "settings.tab_bundles": "Bundles",
  "bundles.title": "Industry Bundles",
  "bundles.description": "Install scenario bundles (skills, MCP, slash commands, CLI, and plugin UI). Built-in bundles work offline; check for updates when online.",
  "bundles.installed_count": "Installed {count}",
  "bundles.updates_count": "{count} update(s) available",
  "bundles.filter_all": "All",
  "bundles.filter_installed": "Installed",
  "bundles.filter_available": "Available",
  "bundles.filter_updates": "Updates",
  "bundles.refresh": "Refresh",
  "bundles.check_updates": "Check updates",
  "bundles.desktop_only": "Industry bundle installation requires the OpenWork Plus desktop app.",
  "bundles.select_workspace": "Select or create a local workspace first.",
  "bundles.import_zip": "Install from ZIP",
  "bundles.import_folder": "Install from folder",
  "bundles.featured": "Featured",
  "bundles.installed_version": "installed v{version}",
  "bundles.install": "Install",
  "bundles.update": "Update",
  "bundles.uninstall": "Uninstall",
  "bundles.empty": "No bundles match this filter. Built-in bundles ship with the app, or import a ZIP.",
  "bundles.pick_zip_title": "Select industry bundle (.zip)",
  "bundles.pick_folder_title": "Select bundle folder",
  "bundles.catalog_url_label": "Hub catalog URL",
  "bundles.catalog_url_placeholder": "https://hub.openwork.plus/catalog.json",
  "bundles.catalog_url_save": "Save & refresh",
  "bundles.catalog_url_dev_default": "Use localhost dev Hub",
  "bundles.catalog_url_hint": "Optional. Set to http://127.0.0.1:9123/catalog.json when running scripts/bundle-hub-dev-server.mjs locally.",
  "bundles.advanced_title": "Advanced",
  "bundles.advanced_hint": "Hub catalog URL, import from ZIP or folder.",
  "docs.knowledge_title": "Knowledge (LLM Wiki)",
  "docs.knowledge_tab_scan": "Scan",
  "docs.knowledge_tab_wiki": "Wiki",
  "docs.knowledge_tab_edit": "Local notes",
  "docs.knowledge_scan_hint": "Scan local documents into a manifest; ingest pending items to create wiki summaries.",
  "docs.knowledge_scan_workspace": "Scan workspace",
  "docs.knowledge_scan_folder": "Pick folder to scan",
  "docs.knowledge_ingest_file": "Ingest file",
  "docs.knowledge_manifest_total": "{n} total",
  "docs.knowledge_manifest_pending": "{n} pending ingest",
  "docs.knowledge_manifest_empty": "No manifest yet. Run a scan first.",
  "docs.knowledge_col_path": "Path",
  "docs.knowledge_col_size": "Size",
  "docs.knowledge_col_status": "Status",
  "docs.knowledge_wiki_hint": "INDEX.md preview (read-only). Full pages live under .openwork/knowledge/wiki/.",
  "docs.knowledge_index_empty": "No INDEX yet. Ingest a document first.",
  "docs.knowledge_ingest_log": "Recent ingest",
  "docs.knowledge_local_notes": "Local notes",
  "docs.knowledge_new": "New",
  "docs.knowledge_no_notes": "No notes yet",
  "docs.knowledge_title_placeholder": "Document title",
  "docs.knowledge_save": "Save",
  "docs.knowledge_delete": "Delete",
  "docs.knowledge_editor_placeholder": "Write Markdown notes here…",
  "docs.knowledge_no_workspace": "Select a workspace first.",
  "docs.knowledge_desktop_only": "Scan and ingest require the desktop Tauri runtime.",
  "docs.knowledge_scan_done": "Scan complete. Manifest updated.",
  "docs.knowledge_ingest_done": "Ingested → {path}",
  "docs.knowledge_pick_scan_root": "Pick folder to scan",
  "docs.knowledge_pick_ingest_file": "Pick file to ingest",
  "docs.knowledge_tab_query": "Search",
  "docs.knowledge_tab_health": "Health",
  "docs.knowledge_wiki_tree": "Wiki pages",
  "docs.knowledge_wiki_select_page": "Select a page on the left to preview",
  "docs.knowledge_query_hint": "Hybrid search: Wiki INDEX/pages first (L1/L2), vector fallback (L3) when needed.",
  "docs.knowledge_query_placeholder": "Ask a question or enter keywords…",
  "docs.knowledge_query_run": "Search",
  "docs.knowledge_query_layer": "Layer {layer} · vector fallback {fallback}",
  "docs.knowledge_save_query": "Save as Wiki Q&A page",
  "docs.knowledge_save_query_done": "Saved under wiki/qa/",
  "docs.knowledge_health_hint": "Lint broken links and orphan pages; auto-fix fixable issues; rebuild vector index.",
  "docs.knowledge_lint_run": "Run lint",
  "docs.knowledge_lint_fix": "Lint & fix",
  "docs.knowledge_rebuild_index": "Rebuild vector index",
  "docs.knowledge_lint_done": "Lint done — {n} issue(s)",
  "docs.knowledge_lint_fixed": "Fixed {n} issue(s)",
  "docs.knowledge_lint_summary": "Errors {errors} · Warnings {warnings} · Total {total}",
  "docs.knowledge_rebuild_done": "Indexed {n} document(s)",
  "docs.knowledge_watch_title": "Directory watch",
  "docs.knowledge_watch_hint": "Auto-ingest inbox files; incremental scan on authorized directories.",
  "docs.knowledge_watch_add_root": "Add watch directory",
  "docs.knowledge_watch_poll": "Poll now",
  "docs.knowledge_watch_auto": "Background polling",
  "docs.knowledge_watch_poll_done": "Poll done — {n} action(s)",
  "docs.knowledge_export_snapshot": "Export wiki snapshot",
  "docs.knowledge_export_done": "Exported {n} page(s) → {path}",
  "settings.tab_description_general": "Connect providers, choose the default model, authorize folders, and control the selected OpenWork Plus workspace plus its runtime connection.",
  ...
  "settings.updates_desc": "Keep OpenWork Plus up to date.",
  ...
  "share.template_item_config_desc": "Reusable commands plus OpenWork Plus/OpenCode config.",
  ...
  "skills.add_openwork_hub": "Add OpenWork Plus Hub",
  ...
  "status.limited_hint": "Reconnect to restore full OpenWork Plus features",
  ...
  "status.openwork_ready": "OpenWork Plus Ready",
  ...
  "system.reload_body_default": "OpenWork Plus detected changes that require reloading the OpenCode instance.",
  "system.reload_body_mcp": "OpenCode loads MCP servers at startup. Reload the engine to activate the new connection.",
  "system.reload_body_mixed": "OpenWork Plus detected OpenCode configuration changes. Reload the engine to apply them.",
