...
export default {
  ...
  "settings.bundles.card_title": "Bundles",
  "settings.bundles.card_desc": "Install and manage industry bundles: packaged skills, MCPs, and plugins.",
  "settings.bundles.title": "Bundles",
  "settings.bundles.description": "Manage installed bundles. Click \"Install from zip\" to add a new bundle from a local .zip file.",
  "settings.bundles.empty_title": "No bundles installed",
  "settings.bundles.empty_hint": "Click \"Install from zip\" above to add one.",
  "settings.bundles.refresh": "Refresh",
  "settings.bundles.install_from_zip": "Install from zip",
  "settings.bundles.uninstall": "Uninstall",
  "settings.bundles.scope_workspace": "This workspace",
  "settings.bundles.scope_user": "User (global)",
  "settings.bundles.installed_on": "Installed",
  "settings.bundles.install_succeeded": "Installed {id}@{version}",
  "settings.bundles.install_failed": "Install failed",
  "settings.bundles.update_succeeded": "Updated {id}@{version}",
  "settings.bundles.update_failed": "Update failed",
  "settings.bundles.update_confirm": "Update {id} to v{version}? Existing Bundle-managed files may be replaced.",
  "settings.bundles.check_updates": "Check updates",
  "settings.bundles.uninstall_succeeded": "Uninstalled {id}",
  "settings.bundles.load_failed": "Failed to load bundles",
  "settings.bundles.requires_desktop_title": "Desktop runtime required",
  "settings.bundles.requires_desktop": "Bundle management is only available in the OpenWork Plus desktop app.",
  "settings.bundles.filter_all": "All",
  "settings.bundles.filter_installed": "Installed",
  "settings.bundles.filter_available": "Available",
  "settings.bundles.source_builtin": "builtin",
  "settings.bundles.source_remote": "remote",
  "settings.bundles.source_local": "local",
  "settings.bundles.install": "Install",
  "settings.bundles.update": "Update",
  "settings.bundles.installed": "installed",
  "settings.bundles.catalog_stale": "Showing cached catalog — remote source was unreachable.",
  "settings.bundles.catalog_error": "Catalog load failed",
  "settings.bundles.zip_only": "Zip only",
  "settings.bundles.no_direct_install_hint": "This entry has no in-app install source. Use \"Install from zip\" with a local archive.",
  "settings.bundles.remote_url_advanced": "Advanced: remote catalog URL",
  "settings.bundles.remote_url_placeholder": "https://your-hub.example.com/catalog.json",
  "settings.bundles.remote_url_save": "Save",
  "settings.bundles.remote_url_clear": "Clear",
  "settings.bundles.remote_url_invalid_invalid": "Enter a valid catalog URL.",
  "settings.bundles.remote_url_invalid_protocol": "Catalog URLs must use HTTPS (localhost HTTP is allowed in development).",
  "settings.bundles.remote_url_invalid_ip_address": "Catalog URLs cannot use a raw IP address.",
  "settings.bundles.remote_url_invalid_path": "Catalog URL must end with /catalog.json or /catalog.",
  "settings.bundles.remote_url_saved": "Remote catalog URL saved",
  "settings.bundles.remote_url_cleared": "Remote catalog URL cleared",
  "settings.bundles.remote_url_active": "Active: {url}",
  "settings.bundles.install_from_dir": "Install from folder",
  "settings.bundles.scope_label": "Install scope:",
  "settings.bundles.scope_user_hint": "Available in all workspaces",
  "settings.bundles.scope_no_workspace": "(no workspace selected)",
  "settings.bundles.export": "Export bundle",
  "settings.bundles.export_succeeded": "Exported {id}@{version}",
  "settings.bundles.export_failed": "Export failed",
  "settings.bundles.export_save_title": "Save bundle zip",
  "settings.bundles.export_pick_source_title": "Select bundle source folder",
  "settings.bundles.export_from_folder": "Export from source folder…",
  "settings.bundles.export_from_folder_hint":
    "Use Export on a catalog or installed card for one-click export. Advanced: pick a source folder that contains bundle.json.",
  "settings.bundles.no_export_hint":
    "No exportable source for this bundle. Install it from catalog or zip first.",
  "settings.bundles.export_restart_hint":
    "Restart the desktop dev server (Ctrl+C, then pnpm --filter @openwork/desktop dev) after main-process updates.",
  "settings.bundles.install_pick_zip_title": "Select bundle zip file",
  "settings.bundles.install_pick_folder_title": "Select bundle folder to install",
