...
const compiledBinaryName = process.platform === "win32" ? "openworkplus-opencode-router.exe" : "openworkplus-opencode-router";
...
console.error(
  `Unable to find an openworkplus-opencode-router entrypoint in ${basename(packageRoot)}. Build the package or run it from a source checkout with Bun available.`,
);
process.exit(1);
