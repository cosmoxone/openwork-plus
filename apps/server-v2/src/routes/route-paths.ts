...
export const routePaths = {
  ...
  workspaces: {
    ...
    router: {
      base: (workspaceId: string = WORKSPACE_ID_PARAMETER) => `${workspaceRoutePath(workspaceId)}/openwork-plus-opencode-router`,
      bindings: (workspaceId: string = WORKSPACE_ID_PARAMETER) => `${workspaceRoutePath(workspaceId)}/openwork-plus-opencode-router/bindings`,
      health: (workspaceId: string = WORKSPACE_ID_PARAMETER) => `${workspaceRoutePath(workspaceId)}/openwork-plus-opencode-router/health`,
      identities: {
        slack: (workspaceId: string = WORKSPACE_ID_PARAMETER, identityId: string = ":identityId") => `${workspaceRoutePath(workspaceId)}/openwork-plus-opencode-router/identities/slack/${identityId}`,
        slackBase: (workspaceId: string = WORKSPACE_ID_PARAMETER) => `${workspaceRoutePath(workspaceId)}/openwork-plus-opencode-router/identities/slack`,
        telegram: (workspaceId: string = WORKSPACE_ID_PARAMETER, identityId: string = ":identityId") => `${workspaceRoutePath(workspaceId)}/openwork-plus-opencode-router/identities/telegram/${identityId}`,
        telegramBase: (workspaceId: string = WORKSPACE_ID_PARAMETER) => `${workspaceRoutePath(workspaceId)}/openwork-plus-opencode-router/identities/telegram`,
      },
      send: (workspaceId: string = WORKSPACE_ID_PARAMETER) => `${workspaceRoutePath(workspaceId)}/openwork-plus-opencode-router/send`,
      slackTokens: (workspaceId: string = WORKSPACE_ID_PARAMETER) => `${workspaceRoutePath(workspaceId)}/openwork-plus-opencode-router/slack-tokens`,
      telegram: (workspaceId: string = WORKSPACE_ID_PARAMETER) => `${workspaceRoutePath(workspaceId)}/openwork-plus-opencode-router/telegram`,
      telegramEnabled: (workspaceId: string = WORKSPACE_ID_PARAMETER) => `${workspaceRoutePath(workspaceId)}/openwork-plus-opencode-router/telegram-enabled`,
      telegramToken: (workspaceId: string = WORKSPACE_ID_PARAMETER) => `${workspaceRoutePath(workspaceId)}/openwork-plus-opencode-router/telegram-token`,
    },
