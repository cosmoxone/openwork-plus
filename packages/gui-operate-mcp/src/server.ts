...
// ESM 下没有 CommonJS 的 __filename/__dirname，这里补齐（原 OC 代码运行于 CJS）。
...
const GUI_APPS_DIR = path.join(OPENWORK_DATA_DIR, 'gui_apps');
