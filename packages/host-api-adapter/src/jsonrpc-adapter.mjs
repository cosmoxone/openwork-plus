...
/**
 * @param {import('@openwork/appserver-contract').JsonRpcRequest | import('@openwork/appserver-contract').JsonRpcNotification} msg
 * @returns {Promise<import('@openwork/appserver-contract').JsonRpcResponse | null>}
 */
